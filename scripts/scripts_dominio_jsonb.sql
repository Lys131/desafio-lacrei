...
DROP DATABASE IF EXISTS planos_dominio_jsonb;
CREATE DATABASE planos_dominio_jsonb;
\c planos_dominio_jsonb;
...
--Inserção de dados no campo JSONB:
INSERT INTO Profissional_Plano (
    id_contrato, 
    id_profissional, 
    id_plano, 
    status_contrato, 
    ...
    '2023-10-15',
    NULL,
    '{"limite_consultas": 10, "horarios_atendimento": ["08:00-12:00", "14:00-18:00"], "observacoes": "Atende apenas com agendamento prévio."}'
);